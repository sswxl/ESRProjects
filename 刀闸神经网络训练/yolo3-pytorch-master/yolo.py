...
class YOLO(object):
    ...
    def detect_image(self, image):
        ...
        for i, c in enumerate(top_label):
            ...
            mark=str(label)
            if 'switchdown' in mark:
                print('The switch is down, and the probability is',"".join(filter(str.isdigit, mark)))
            if 'switchup' in mark:
                print('The switch is up, and the probability is', "".join(filter(str.isdigit, mark)))
            if 'redI' in mark:
                print('The button is down, and the probability is', "".join(filter(str.isdigit, mark)))
            if 'greenO' in mark:
                print('The button is down, and the probability is', "".join(filter(str.isdigit, mark)))
